		...
		<div class="parallax2 pb-4" id="sobre">
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Configuração de Cadastro</h2></a>
					</div>
				</div>
			</div>
			<div class="card mt-2" id="card1">
				...
				<div class="jumbotron-fluid">
					<div class="container">
						<a href="novocad.php" class="text-center"><p id="item">Adicionar Novo Usuario/Funcionário</p></a>
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									while($f = mysqli_fetch_array($consulta)){
										...
										<tr class="text-white">
											<th scope="row"><?php echo $idcad ?></th>
											<td><?php echo $nome ?></td>
											...
											<td><?php echo $adm ?></td>
											<td><?php echo "***" ?></td>
											<td><a href="altcad2.php?idcad=<?php echo $idcad; ?>"><i style="color:#dee2e6;" class="far fa-edit fa-2x"></i></a></td>
											<td><a href="exccad2.php?idcad=<?php echo $idcad; ?>"><i style="color:#dee2e6" class="far fa-trash-alt fa-2x"></i></a></td>
										</tr>
										<?php 
									}
									?>
