			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card mr-5" id="card1">
						<a href="altport.php" id="item" class="text-center"><h2>Configurar <br>Portfolio</h2></a>
					</div>
					<div class="card" id="card1">
						<a href="altsob.php" id="item" class="text-center"><h2>Configurar <br>Sobre Nós</h2></a>
					</div>
				</div>
				<div class="card-group pb-5">
					<div class="card mt-0 pb-6" id="card1">
						<a href="altcolab.php" id="item" class="text-center"><h2>Configurar<br> Colaboradores</h2></a>
					</div>
				</div>
				<?php 
				$sessão = $_SESSION['email'];
				if(isset($_SESSION['email'])){
					if ($sessão == 'admin@gmail.com'){
						echo "<div class='card-group pb-5'>
						<div class='card mt-0 pb-6' id='card1'>
						<a href='altcad.php' id='item' class='text-center'><h2>Configurar<br> Cadastros</h2></a>
						</div>
						</div>";
					}
				}
				...
				<div class="card-group pb-5">
					<div class="card mt-0 pb-6" id="card1">
						<a href="index.php" id="item" class="text-center"><h2>Ir para Home</h2></a>
					</div>
				</div>
				<div class="card-group">
					<div class="card mt-0 pb-6" id="card1">
						<a href="sair.php" id="item" class="text-center"><h2>Fechar Sessão</h2></a>
					</div>
				</div>
			</div>
		</div>
