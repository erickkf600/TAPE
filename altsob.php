			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Configurar Sobre Nós</h2></a>
					</div>
				</div>
			</div>
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									while($f = mysqli_fetch_array($consulta)){
										...
										<tr class="text-white">
											<th scope="row"><?php echo $idsobre ?></th>
											<td><?php echo $missao ?></td>
											<td><?php echo $visao ?></td>
											<td><?php echo $valores ?></td>
											<td><?php echo $nossahistoria ?></td>
											<td><a href="altsob2.php?idsobre=<?php echo $idsobre; ?>"><i style="color:#dee2e6;" class="far fa-edit fa-2x"></i></a></td>
