			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Adicionar Novo Colaborador</h2></a>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="novocolab2.php" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idcolab"></th>
											<td><input autofocus maxlength="1" type="text" class="form-control" name="adm" placeholder="S ou N"></td>
											<td><input type="text" class="form-control" name="nome"></td>
											<td><input type="text" class="form-control" name="telefone"></td>
											<td><input type="text" class="form-control" name="descricao"></td>
											<td><input type="text" class="form-control" name="subdescricao"></td>
											<td><input type="file" class="form-control" name="arquivo"></td>
											<td><input type="text" class="form-control" name="facebook"></td>
											<td><input type="text" class="form-control" name="twitter"></td>
											<td><input type="text" class="form-control" name="github"></td>
										</tr>
									</tbody>
