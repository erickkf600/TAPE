					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="altport3.php?idproj=<?php echo $idproj; ?>" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idproj" value="<?php echo $idproj; ?>"></th>
											<td><input autofocus type="text" class="form-control" name="nome" value="<?php echo $nome; ?>"></td>
											<td><input type="text" class="form-control" name="site" value="<?php echo $site; ?>"></td>
											...
											<td><input type="text" class="form-control" name="empresa" value="<?php echo $empresa; ?>"></td>
										</tr>
									</tbody>
									<button type="submit">Modificar</button>
								</form>
								<a href="altport.php"><button>Voltar</button></a>
							</div>
						</table>
					</div>
				</div>
