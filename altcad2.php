...
$idcad = $_GET['idcad'];
include "banco.php";
$query = "select * from cadastro where idcad = $idcad limit 1";
			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Editar Usuario/Funcionario</h2></a>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="altcad3.php?idcad=<?php echo $idcad; ?>" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idcad" value="<?php echo $idcad; ?>"></th>
											<td><input autofocus type="text" class="form-control" name="nome" value="<?php echo $nome; ?>"></td>
											...
											<td><input type="text" class="form-control" name="cargo" value="<?php echo $cargo; ?>"></td>
											<td><input type="text" class="form-control" name="adm" value="<?php echo $adm; ?>"></td>
											<td><input type="password" class="form-control" name="senha" value="<?php echo $senha; ?>"></td>
										</tr>
									</tbody>
									<button type="submit">Modificar</button>
								</form>
								<a href="altcad.php"><button>Voltar</button></a>
							</div>
						</table>
					</div>
				</div>
