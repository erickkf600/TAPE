		...
		<div class="parallax2 pb-4" id="sobre">
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Configuração de Colaboradores</h2></a>
					</div>
				</div>
			</div>
			<div class="card mt-2" id="card1">
				...
				<div class="jumbotron-fluid">
					<div class="container">
						<a href="novocolab.php" class="text-center"><p id="item">Adicionar Novo Colaborador</p></a>
						<a href="painel.php" class="text-center"><p id="item">Voltar para o painel</p></a>
						<div class="row">
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									while($f = mysqli_fetch_array($consulta)){
										...
										<tr class="text-white">
											<th scope="row"><?php echo $idcolab ?></th>
											<td><?php echo $adm ?></td>
											<td><?php echo $nome ?></td>
											<td><?php echo $telefone ?></td>
											<td><?php echo $descricao ?></td>
											<td><?php echo $subdescricao ?></td>
											<td><?php echo $img ?></td>
											<td><?php echo $facebook ?></td>
											<td><?php echo $twitter ?></td>
											<td><?php echo $github ?></td>
											<td><a href="altcolab2.php?idcolab=<?php echo $idcolab; ?>"><i style="color:#dee2e6;" class="far fa-edit fa-2x"></i></a></td>
											<td><a href="exccolab2.php?idcolab=<?php echo $idcolab; ?>"><i style="color:#dee2e6" class="far fa-trash-alt fa-2x"></i></a></td>
										</tr>
										<?php 
									}
									?>
