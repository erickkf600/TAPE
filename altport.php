		...
		<div class="parallax2 pb-4" id="sobre">
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Configuração de Portfólio</h2></a>
					</div>
				</div>
			</div>
			<div class="card mt-2" id="card1">
				...
				<div class="jumbotron-fluid">
					<div class="container">
						<a href="novo.php" class="text-center"><p id="item">Adicionar Novo Projeto</p></a>
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									while($f = mysqli_fetch_array($consulta)){
										...
										<tr class="text-white">
											<th scope="row"><?php echo $idproj ?></th>
											<td><?php echo $nome ?></td>
											<td><?php echo $site ?></td>
											<td><?php echo $descricao ?></td>
											<td><?php echo $img ?></td>
											<td><?php echo $empresa ?></td>
											<td><a href="altport2.php?idproj=<?php echo $idproj; ?>"><i style="color:#dee2e6;" class="far fa-edit fa-2x"></i></a></td>
											<td><a href="excport2.php?idproj=<?php echo $idproj; ?>"><i style="color:#dee2e6" class="far fa-trash-alt fa-2x"></i></a></td>
										</tr>
										<?php 
									}
									?>
