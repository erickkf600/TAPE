			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Remoção de Usuario/Funcionario</h2></a>
					</div>
				</div>
			</div>
				...
				<div class="jumbotron-fluid">
					<div class="container">
						...
						<div class="row">
							...
							$idcad = $_GET['idcad'];
							include "banco.php";
							echo "Tem certeza que deseja excluir item n° $idcad?";
							echo "<p><a href='altcad.php'>Não</a></p>";
							echo "<a href='exccad3.php?idcad=$idcad'>Sim</a>";
							?>
