			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Adicionar Novo Projeto</h2></a>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="novo2.php" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idproj"></th>
