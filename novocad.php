			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Adicionar Novo Usuario/Funcionário</h2></a>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="novocad2.php" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idcad"></th>
											<td><input autofocus type="text" class="form-control" name="nome"></td>
											<td><input type="text" class="form-control" name="celular"></td>
											<td><input type="text" class="form-control" name="email"></td>
											<td><input type="text" class="form-control" name="cargo"></td>
											<td><input type="text" maxlength="1" class="form-control" name="adm"></td>
