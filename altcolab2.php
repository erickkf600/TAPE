			...
			<nav id="navbar">
				...
				<div class="menu">
					<ul>
						...
						<li><a href="#proj" id="item">Portfolio</a></li>
			...
			<div class="container" id="info">
				<div class="card-group pb-5">
					<div class="card" id="card1">
						<a href="" id="item" class="text-center"><h2>Editar Colaborador</h2></a>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<table class="table table-striped">
							<div class="row">
								...
								<form method="post" action="altcolab3.php?idcolab=<?php echo $idcolab; ?>" enctype="multipart/form-data">
									<tbody>
										<tr>
											<th scope="row"><input disabled type="text" class="form-control" name="idcolab" value="<?php echo $idcolab; ?>"></th>
											<td><input autofocus maxlength="1" type="text" class="form-control" name="adm" value="<?php echo $adm; ?>"></td>
											<td><input type="text" class="form-control" name="nome" value="<?php echo $nome; ?>"></td>
											<td><input type="text" class="form-control" name="telefone" value="<?php echo $telefone; ?>"></td>
											<td><input type="text" class="form-control" name="descricao" value="<?php echo $descricao; ?>"></td>
											<td><input type="text" class="form-control" name="subdescricao" value="<?php echo $subdescricao; ?>"></td>
											<td><input type="file" class="form-control" name="arquivo" value="<?php echo $img; ?>"></td>
											...
											<td><input type="text" class="form-control" name="github" value="<?php echo $github; ?>"></td>
										</tr>
									</tbody>
									<button type="submit">Modificar</button>
								</form>
								<a href="altcolab.php"><button>Voltar</button></a>
							</div>
						</table>
					</div>
				</div>
